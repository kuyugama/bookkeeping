...
from src.util import typing_util
...
class APIError(fastapi.HTTPException):
    ...
    def model(self) -> type[ErrorModel]:
        ...
        model_name = (
            "Error_" + snake_to_camel(self.category, "/") + "_" + snake_to_camel(self.code, "-")
        )
...
def define_error_category(category: str) -> typing_util.DefineErrorProtocol:
